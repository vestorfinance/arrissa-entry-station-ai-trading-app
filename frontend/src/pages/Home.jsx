...
// The Model Context Protocol's own mark, drawn rather than fetched: an <img>
// here would be a request that can fail on the one section explaining an
// integration, and this is nine paths of geometry.
function McpMark() {
  return (
    <svg viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor"
         fillRule="evenodd" aria-hidden="true" focusable="false">
  ...
  return (
    <div className="home">
      ...
      <section className="home-band">
        <div className="home-wrap">
          {/* The protocol's own mark, above a centred heading that had nothing
              to anchor it. Everything in this section is text; one shape at the
              top gives the eye somewhere to start and balances the two columns
              underneath. */}
          <span className="home-mcp-badge" aria-hidden="true"><McpMark /></span>
